        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Earnings_Wallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Periodicity = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    RecurrenceKind = table.Column<int>(type: "int", nullable: false),
                    RRule = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenerateInstances = table.Column<bool>(type: "bit", nullable: false),
                    CalculatedInstallmentAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InstallmentPlans_Expenses_ExpenseId",
                        column: x => x.ExpenseId,
                        principalTable: "Expenses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Earnings_WalletId",
                table: "Earnings",
                column: "WalletId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseInstances_ExpenseId_DueDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstallmentPlans_ExpenseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wallets_UserId_IsPrimary",
                table: "Wallets",
