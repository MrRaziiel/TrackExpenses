...
export function pageConfigurations(){
  ...
  return(
      ...
      secondconfigurationPage : 
        ...
        { label: "Date", lower: "birthday", placeholder: "Date", Required: true, type: "date" , pattern:"", value: "", icon: <Calendar className="h-5 w-5" style={{ color: theme?.colors?.text?.secondary }}max: true  />, max: true },
        { label: "Phone", lower: "phonenumber", placeholder: "00000000000", Required: false, type: "tel", pattern:"^\d+$", value: "" },
        { label: "Code Invite", lower: "codeinvite", placeholder: "Group Code", type: "Text" , Required: false, pattern:"", value: "", icon: "" },
        ]
      }
    )
}
