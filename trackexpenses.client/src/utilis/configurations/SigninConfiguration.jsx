...
export function pageConfigurations(){
  ...
  return(
      ...
      secondconfigurationPage : 
        ...
        { label: "Date", lower: "birthday", placeholder: "Date", Required: true, type: "date" , pattern:"", value: "", icon: <Calendar className="h-5 w-5" style={{ color: theme?.colors?.text?.secondary }} />, },
